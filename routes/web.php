...
Route::group(['prefix'=>'loginUser', 'middleware'=>'CheckLoginUser'], function (){
	Route::get('/', 'LoginUserController@getLogin');
	Route::post('/', 'LoginUserController@postLogin');
});

Route::get('movieSelect/{id}', 'FrontendController@getMovieSelect');
...
// Route::get('upMovie', 'UploadController@getUpMovie');
// Route::post('upMovie', 'UploadController@postUpMovie');
...
Route::resource('upLoadMovie', 'UpLoadMovieController');
