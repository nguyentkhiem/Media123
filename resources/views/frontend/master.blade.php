...
<head>
	...
	<link rel="stylesheet" href="css/movieselect.css">
		...
		<div class="container">
			<div class="row">
				...
				<div id="User" class="col-md-4 col-sm-12 col-xs-12">
					@auth<h3><img style="margin:0px 5px; width: 40px; height: 40px; border-radius: 40px;" src="{{asset('storage/avatar/'.Auth::user()->user_img)}}"> {{Auth::user()->user_name}} <i class="fas fa-hand-peace"></i></h3>@endauth
					
				</div>
				<div id="cart" class="col-md-2 col-sm-12 col-xs-12">
					@guest
					<a style="padding: 0px; margin: 0px;" href="{{asset('loginUser')}}"><button style="font-size:14px;" type="button" class="btn btn-success">Đăng nhập <i class="fas fa-bell"></i></button></a>
					@endguest
					@auth
					<a style="padding: 0px; margin: 0px;" href="{{asset('logout')}}"><button style="font-size:14px;" type="button" class="btn btn-primary"><i class="fas fa-sign-out-alt"></i> Đăng xuất</button></a>
					@endauth
				...
				<div id="sidebar" class="col-md-3">
					<nav id="menu">
						<ul>
							...
							<li class="menu-item"><a href="{{asset('listMovie')}}" title="Phim Truyện">Phim Truyện</a></li>
							<li class="menu-item"><a href="{{asset('listMusic')}}" title="Âm Nhạc">Âm Nhạc</a></li>
							<li class="menu-item"><a href="{{asset('listNews')}}" title="Tin Tức">Tin Tức</a></li>
							<li class="menu-item"><a href="{{asset('listImage')}}" title="Hình Ảnh">Hình Ảnh</a></li>	
					...
					<div id="banner-l" class="text-center">
						...
						@foreach($banners as $banner)
							<div class="banner-l-item">
								<a target="_blank" href="{{$banner->banner_link}}"><img src="{{asset('storage/avatar/'.$banner->banner_logo)}}" alt="" class="img-thumbnail"></a>
							</div>
						@endforeach
					</div>
