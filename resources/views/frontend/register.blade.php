                            ...
                            @include('flash::message')
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <input @if($errors->get('name')) style="border-color: red;" @endif type="text" name="name" class="form-control" placeholder="Fullname"  />
                                        <span style="color: red;"> @foreach($errors->get('name') as $name) {{$name}} @endforeach </span>
                                    </div>
                                    <div class="form-group">
                                        <label>Email</label><span id="sao"> *</span>
                                        <input @if($errors->get('email')) style="border-color: red;" @endif type="text" name="email" class="form-control" placeholder="Email"  />
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input @if($errors->get('password2')) style="border-color: red;" @endif type="password" name="password2" class="form-control" placeholder="Password" />
