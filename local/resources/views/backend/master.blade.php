...
<body>
  <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container-fluid">
      <div class="navbar-header">
        <a class="navbar-brand" style="line-height: 30px;" href="{{asset('admin/home')}}">MediaPort Admin</a>
        <ul class="user-menu">
          <li class="dropdown pull-right">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><img style="margin-top: -5px; margin-right:10px; width: 40px; height: 40px; border-radius: 40px;" src="{{asset('local/storage/app/avatar/'.Auth::user()->user_img)}}"> {{Auth::user()->user_name}}<span class="caret"></span></a>
  ...
  <div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
    <ul class="nav menu">
      ...
      <li><a href="{{asset('/')}}"><svg class="glyph stroked eye"><use xlink:href="#stroked-eye"></use></svg> Trang người dùng</a></li>
